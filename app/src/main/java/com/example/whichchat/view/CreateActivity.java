...
public class CreateActivity extends AppCompatActivity {
    ...
    public void newUser(String id, String name, String mobile, String desc) {
        ...
        DatabaseReference mDatabase = FirebaseDatabase.getInstance("https://fir-kotin-4697d-default-rtdb.europe-west1.firebasedatabase.app/users/uF4rbKDt7JNL9fTSQsIgxWh3vuF3").getReference();
